                ...
                if (products) {
                    ...
                    Object
                        ...
                        .forEach(id => {
                            ...
                            let priceHistorySortedAndFiltered = p
                                .PriceHistorySorted
                                .filter(priceDate => (priceDate <= lastWriteTime.BasePriceTime && priceDate !== p.PriceHistorySorted[0]));
...
exports.keepGetOnSaleProductsHttpAlive = functions
    .pubsub
        ...
        if (req.method === 'OPTIONS') {
            ...
            Object
                ...
                .forEach(id => {
                    ...
                    highestScore = p.numberOfMatches > highestScore
                        ? p.numberOfMatches
                        : highestScore;
            ...
            matchingProducts.map(p => {
                ...
                let priceHistorySortedAndFiltered = p
                    .PriceHistorySorted
                    .filter(priceDate => (priceDate <= allTimeEarliestDate && priceDate !== p.PriceHistorySorted[0]));
...
exports.stockUpdateListener = functions
    ...
    .onWrite(async(change, context) => {
        ...
        const count = newValue.length > 500
            ? 500
            : newValue.length;
