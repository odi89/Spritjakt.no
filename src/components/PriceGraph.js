...
class PriceGraph extends React.Component {
	...
	render() {
        ...
        let numberOfDays = ( today.getTime() - pricesReversed[0] ) / millisecondsPerDay;
        ...
        let priceSortedByAmount = SortArray(Object.values(p.PriceHistory), {order: "desc"});
		...
		return (
            ...
            <div className="graph">
                <ResponsiveLine
                    ...
                    yScale={{ type: 'linear', min: minPrice, max: maxPrice, stacked: false, reverse: false }}
                    curve="step"
                    axisTop={null}
                    axisRight={null}
                    axisLeft={{
