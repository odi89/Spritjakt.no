...
class SearchBar extends React.Component {
    ...
    async SearchProducts(searchString) {
        ...
        firebase
            .analytics()
            .logEvent('product_search', {value: searchString});
    }
        ...
        if (list.length === 0) {
            list.push(
                <p
                    ...
                    width: "100%",
                    position: "absolute"
                }}>Fant ikke noe.<br/>Men så er denne søkefunksjonen shit også da...</p>
            );
        }
        return list;
    }
    ...
    render() {
        return (
            <div className="SearchBar">
                ...
                {this.state.searchString.length >= 3 && <div className="wrapper">
                    <button className="close" onClick={() => this.setState({searchString: ""})}>
